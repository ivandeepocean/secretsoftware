...
or Description Like  '%" + searchqry + "%' or Quantity Like  '%" + searchqry + "%' or Size Like  '%" + searchqry + "%'"

        cmd = New MySqlCommand(sql, conn)
        dr = cmd.ExecuteReader

        While dr.Read
            DataGridView1.Rows.Add(dr("ProductCode"), dr("ProductName"), dr("Description"), dr("Quantity"), dr("Size"))
        End While
